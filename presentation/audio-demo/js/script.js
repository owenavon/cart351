  ...
  function soundVisualizer() { // Sound Visualizer
    ...
    analyser.fftSize = TWO_FIVE_SIX; // Represents window size in samples when getting data. COnverting frequency to hz
    ...
    let dataArray = new Uint8Array(bufferLength); // Assigns dataArray to special array of 8-bit unsigned integers. The Uint8Array typed array represents an array of 8-bit unsigned integers. The contents are initialized to 0
